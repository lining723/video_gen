...
3. **Incremental or full audit?** If reviewing recent changes (a Bits-Code MR or feature branch), focus on new/modified code and check whether it maintains existing parity. For a full audit, scan systematically.
