...
description: Produces Go/No-Go deployment checklists with SQL verification queries, rollback procedures, and monitoring plans. Use when MRs touch production data, migrations, or risky data changes.
---
...
Given a Bits-Code MR that touches production data, you will:
...
```markdown
# Deployment Checklist: [Bits-Code MR Title]
...
- Bits-Code MR touches database migrations with data changes
- Bits-Code MR modifies data processing logic
- Bits-Code MR involves backfills or data transformations
